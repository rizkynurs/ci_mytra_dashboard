...
class Chart_model extends CI_Model
{
	...
	{
		$query=$this->db->query("SELECT d.date, count(i.id) from (select to_char(date_trunc('day', (date '2017-08-20' + offs)), 'yyyy-mm-dd') as date from generate_series(0,6,1) as offs) d left outer join invoice i on d.date=to_char(date_trunc('day', i.invoice_date), 'yyyy-mm-dd') group by d.date order by d.date asc;")
	...
	{
		$res = $this->db->query("SELECT d.date, sum(total) from (select to_char(date_trunc('day', (date '2017-08-20' + offs)), 'yyyy-mm-dd') as date from generate_series(0,6,1) as offs) d left outer join invoice i on d.date=to_char(date_trunc('day', i.invoice_date), 'yyyy-mm-dd') group by d.date order by d.date asc;");
	...
	function data_chart_income_yearly()
	{
		...
		$res2 = $this->db->query("SELECT d.date, sum(sum(total)) over() as sum from (select to_char(date_trunc('day', (date '2018-01-01' + offs)), 'yyyy-mm-dd') as date from generate_series(0,365,1) as offs) d left outer join invoice i on d.date=to_char(date_trunc('day', i.invoice_date), 'yyyy-mm-dd') group by d.date order by d.date asc limit 1;");

		$res3 = $this->db->query("SELECT d.date, sum(sum(total)) over() as sum from (select to_char(date_trunc('day', (date '2019-01-01' + offs)), 'yyyy-mm-dd') as date from generate_series(0,365,1) as offs) d left outer join invoice i on d.date=to_char(date_trunc('day', i.invoice_date), 'yyyy-mm-dd') group by d.date order by d.date asc limit 1;");

		$res4 = $this->db->query("SELECT d.date, sum(sum(total)) over() as sum from (select to_char(date_trunc('day', (date '2020-01-01' + offs)), 'yyyy-mm-dd') as date from generate_series(0,366,1) as offs) d left outer join invoice i on d.date=to_char(date_trunc('day', i.invoice_date), 'yyyy-mm-dd') group by d.date order by d.date asc limit 1;");
